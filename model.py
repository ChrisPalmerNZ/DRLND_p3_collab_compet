...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fc1_units=400, fc2_units=300, leakiness=0.01, kaiming=False):
    ...
    def forward(self, state):
        ...
        if self.leakiness > 0:
            ...
            x = F.leaky_relu(self.bn2(self.fc2(x)), negative_slope=self.leakiness)
        else:    
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fcs1_units=400, fc2_units=300, leakiness=0.01, kaiming=False):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
